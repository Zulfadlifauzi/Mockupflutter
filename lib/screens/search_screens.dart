...
import 'package:mockupmymosq/screens/tabBar/events_screens.dart';
import 'package:mockupmymosq/screens/tabBar/group_screens.dart';
import 'package:mockupmymosq/screens/tabBar/opportunities_screens.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text('Explore',style: GoogleFonts.lato(
            color: kTextColor,
            letterSpacing: .5,
                                ...
                                return Stack(
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: Padding(
                                        padding:
                                            EdgeInsets.fromLTRB(100.0, 10.0, 20.0, 20.0),
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: <Widget>[
                                            Row(
